 ...
 * @discussion - SCILabelAlignmentHorizontal_Default for top or bottom aligned axis it is equal to SCILabelAlignmentHorizontal_Center, if axis is left align is it equal to SCILabelAlignmentHorizontal_Left and for right aligned axis it is SCILabelAlignmentHorizontal_Right
 * @discussion - SCILabelAlignmentHorizontal_Center label will not be moved from calculated origin (centred)
 * @discussion - SCILabelAlignmentHorizontal_Left default for left aligned axis, for right aligned - label will be flipped to chart surface, for horizontal axes label will be flipped to left from origin point
 * @discussion - SCILabelAlignmentHorizontal_Right default for right aligned axis, for left aligned - label will be flipped to chart surface, for horizontal axes label will be flipped to right from origin point
 */
