 ...
 * @see SCILegendCell
 */
@property (nonnull, readonly) id<SCIRenderableSeries> renderebleSeries;
 ...
 * @see SCILegendCell
 */
- (_Nonnull instancetype)initWithRenderebleSeries:(_Nonnull id<SCIRenderableSeries>)series;
